...
ノートの中に `quiz` ブロックを置くと、その場で開いて答えを確かめられる問いになる。読んで分かった
つもりになった内容を、あとから思い出せるようにするためのもの。
...
- **ノートの文脈の中に置く。** 問いを別ファイルに集めない。カードは文脈から切り離されると意味が
  痩せ、本文と乖離して腐る。
- 関係する節を読み終えた直後に置く。ノートの末尾にまとめない。
...
- ノートを書いたら、そこから問いを1〜3個作る。**その場で調べた事実より、実際に動かして分かったこと
  や、間違えやすい点を優先する。**
